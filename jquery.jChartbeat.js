  ...
  function makeRequest (url, callback, params) {
   ...
   $.jChartbeat.paths = {
    ...
    $.jChartbeat.histogram = function (callback, params) {
     ...
     $.jChartbeat.topgroups = function (callback, params) {
       var request = $.jChartbeat.realTimeBaseUrl + $.jChartbeat.paths.topGroups;
       makeRequest(request, callback, params);
     };

	 $.jChartbeat.dash = function (callback, params) {
       var request = $.jChartbeat.realTimeBaseUrl + $.jChartbeat.paths.dash;
       makeRequest(request, callback, params);
     };
